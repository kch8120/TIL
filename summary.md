...
변수가 모든 블록에 살아있으면 코드가 복잡해진다고 보는 것이다.<br><br><br>
그래서 개발자들은 지역변수 라는 개념을 만들었다.<br><br><br>
...
거짓말은 아니다.<br><br>
다만 바꾸려면 절차가 좀 더 필요하고 정확성이 떨어질 뿐이다.<br><br><br>
예를 들어보자.<br><br>
...
최대범위를 넘어서면 최소범위에서 다시 시작한다.<br><br><br>
시계를 생각하면 편하다.<br><br>
