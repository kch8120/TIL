...
변수에는 여러 가지 종류가 있는데, 바로 숫자, 문자(한 문자), 문자열(여러 문자)이다.<br>
그런데 만약 당신이 숫자를 넣을 수 있는 변수를 만든다 하자.<br>
그럴 때 당신은 정수/실수, 수의 범위 등을 고려해야 한다.<br>
정수와 실수의 데이터형은 서로 다르며, 수의 범위에 따라서도 데이터형이 다르기 때문이다.<br>
주로 정수는 int, 실수는 double을 쓰며,<br>
수의 범위가 -2147483648~2147483647에 해당한다면 int,<br>
그 이상이면 long, 그것보다 더 크면 double을 쓴다.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    /&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/       <br>
int&nbsp;&nbsp;&nbsp;    long&nbsp;&nbsp;&nbsp;    double 이다.<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    \&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;\<br>
